...
Visualizing float no float for both species, and sprout or no sprout, across treatments and collection sites
...
#two columns, add in radicle length to combined plot
CharPlot1<-grid.arrange(VAVGElength,VLARAlength,VAVGEwidth,VLARAwidth,VAVGEmass,VLARAmass,VAVGEradlength, ncol=2)
