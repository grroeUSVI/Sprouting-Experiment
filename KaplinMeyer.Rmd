...
#going to remove these, removal date isnt noted for these
sprout<-sprout%>%
...
#plotting LARA
LARAplotobj<-ggsurvplot(LARAsurv, data=LARA,
  palette = c("olivedrab","cornflowerblue","darkblue","salmon4"))

LARAplotobj

#the ggsurvplot doesn't just create a plot, it creates a list of things containing the plot, in order to add ggplot layers you have to pull the plot out of the list
...
#plotting AVGE
AVGEplotobj<-ggsurvplot(AVGEsurv, data=AVGE,
  palette = c("olivedrab","cornflowerblue","darkblue","salmon4"))
AVGEplotobj
...
Stat squid Kaplin Meyer tutorial
